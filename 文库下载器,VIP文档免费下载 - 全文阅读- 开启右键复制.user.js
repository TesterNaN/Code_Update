// ==UserScript==
// @name         文库下载器,VIP文档免费下载 | 全文阅读| 开启右键复制（净化，去验证码版本）
// @version      1.6.3
// @description  【本脚本功能】保持源文件排版导出 PDF 文件，解除继续阅读限制，净化弹窗、广告，开启文库本地 VIP
// @author       TesterNaN
    ...
    var Wenku = {
        ...
        Downdocs:function(){
         ...
         `;
                    ...
                    contenthtml +='<div class="zhihu-form-item" style="color: #acaeb5;"><div class="zhihu-input-block"><p>已破解，随意输入</p></div></div>'
                    ...
                    contenthtml +='</div><div class="zhihu-scan"><img src="http://activity.hdslb.com/zzjs/20160608appDownload/img/pc/QRcode.png"><h1>下载哔哩哔哩</h1>'
                    contenthtml +='<div style="font-size: 12px;color: #000;margin-left:15px;text-align: left;"><div style="line-height: 2;text-align: center;">Cracked by TesterNaN</div></div></div></form>'
                    Wenku.open({
                        area: ['520', '380'],
